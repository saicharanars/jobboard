...
export class  $npmConfigName1719991061188 implements MigrationInterface {
    name = ' $npmConfigName1719991061188'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."job_user_role_enum" AS ENUM('job_candidate', 'job_employer')`);
        ...
        await queryRunner.query(`ALTER TABLE "job_user" ALTER COLUMN "role" SET DEFAULT 'job_candidate'`);
