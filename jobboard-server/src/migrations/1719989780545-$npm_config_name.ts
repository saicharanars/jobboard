...
export class  $npmConfigName1719989780545 implements MigrationInterface {
    name = ' $npmConfigName1719989780545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."job_user_role_enum" AS ENUM('company', 'applicant')`);
        ...
        await queryRunner.query(`ALTER TABLE "job_user" ALTER COLUMN "role" SET DEFAULT 'applicant'`);
